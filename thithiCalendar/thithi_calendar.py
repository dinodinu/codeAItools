...
_PALETTE_COLORS = {
    QPalette.ColorRole.Window:          "#fdf6e3",
    QPalette.ColorRole.WindowText:      "#222",
    QPalette.ColorRole.Base:            "#fff",
    QPalette.ColorRole.AlternateBase:   "#f7f0e0",
    QPalette.ColorRole.Text:            "#222",
    QPalette.ColorRole.ButtonText:      "#222",
    QPalette.ColorRole.Button:          "#f0e6d2",
    QPalette.ColorRole.Highlight:       "#d35400",
    QPalette.ColorRole.HighlightedText: "#fff",
    QPalette.ColorRole.ToolTipBase:     "#fff",
    QPalette.ColorRole.ToolTipText:     "#222",
}
...
class ThithiCalendarApp(QMainWindow):
    ...
    def _export_chaturthi_ics(self):
        ...
        while d <= end:
            ...
            tnum = int(elong / 12.0)
            if (tnum if tnum < 15 else tnum - 15) == 3:  # Chaturthi
...
def main():
    ...
    palette = app.palette()
    for role, color in _PALETTE_COLORS.items():
